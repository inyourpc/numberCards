(function (ns, $) {
    ...
    var defaultStateObj = {chk1: false, chk2: false, sel1: 0, sel2: 2};
    ...
    function updateStateObj() {
        ...
        //ntrolPanel.self.currentStateObj.chk1 = document.getElementById('checkbox-0').checked;
        ControlPanel.self.currentStateObj.chk2 = checkBoxStatus('#cardValues');
        ControlPanel.self.currentStateObj.sel1 = selectStatus('#select1');
        ControlPanel.self.currentStateObj.sel2 = selectStatus('#select2');
        var jj = document.getElementById('select-1').selectedIndex;
        console.log("jj = "+jj);
console.log($("#color3").val());        
       //var  hex = "#" + jQuery(colpkr).find('color3').val();
        //console.log(hex);
        console.log("check box 2 = "+ControlPanel.self.currentStateObj.chk2);
        console.log('ControlPanel:updateStateObj'+"number of cards"+jj+""+"type of cards"+document.getElementById('select-2').selectedIndex);
         }

    function checkBoxStatus(cb) {
        //alert($(cb).is(':checked'));
        return $(cb).is(':checked') ? true : false;
        //return $('.messageCheckbox:checked').val();
    }
    ...
    ControlPanel.prototype.getCurrentState = function () {
        ...
        console.log("ControlPanel:getCurrentStateyawer");
